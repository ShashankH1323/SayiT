"""Core tkinter control window for Say It: live state, input-level meter, mic
...
from sayit import history, models
from sayit.app import State
from sayit.audio import list_input_devices, refresh_input_devices
from sayit.stt import GROQ_AVAILABLE_MODELS
...
class SayItUI:
    """Status/control window for a running SayItApp (poll-driven, 100 ms)."""
    ...
    def _build_settings(self) -> None:
        ...
        # 4. Sound effects toggle (Say It earcons)
