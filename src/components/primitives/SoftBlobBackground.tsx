...
export function SoftBlobBackground({ className, variant = "full" }: SoftBlobBackgroundProps) {
  return (
    ...
    >
      ...
      />
      {/* Static blobs. The continuous animate-blob-drift was removed: transforming
          a blur-3xl layer every frame forces the transparent WebView2 window to
          re-composite nonstop (a core contributor to the onboarding freeze). Static
          blobs rasterize once and then cost nothing. */}
