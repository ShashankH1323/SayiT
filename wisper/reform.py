"""Groq-backed transcript reform (FORMAT mode) for Wisper.
...
FALLBACK_MODELS = ("qwen/qwen3.8-27b", "openai/gpt-oss-20b", "openai/gpt-oss-120b", "llama-3.3-70b-versatile", "llama-3.1-8b-instant")

PROMPTS = {
    "light": (
        "You are Wisper Flow, an authentic, context-aware speech dictation editor. Your job is to transform "
